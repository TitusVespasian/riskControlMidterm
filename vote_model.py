...
def get_model_param(adjusted_weight):
    lgb_best_pa = {'n_estimators': 278, 'max_depth': 12, 'num_leaves': 31,
    ...
    lgb_model = lgb.LGBMClassifier(boosting_type='gbdt', objective='binary', metrics='auc', learning_rate=0.001,
                                   ...
                                   n_estimators=15000, is_unbalance=True)
...
models = {"lgb": lgb_model_, "xgb": xgb_model, "rf": rf_model,
          "vote": VotingClassifier(estimators=[("lgb", lgb_model_), ("xgb", xgb_model)], voting='soft')}
