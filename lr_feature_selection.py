...
# 'Education_Info2'
plot_haves(train_master, 'Education_Info2', 'E')
temp = train_master['Education_Info2'].copy()
train_master['Education_Info2'] = temp.apply(lambda x: 1 if x == 'E' else 0)

# 'Education_Info3'
print(train_master['Education_Info3'].value_counts())
# len=3
train_master = train_master.join(pd.get_dummies(train_master.Education_Info3, prefix="Education_Info3"))
train_master.drop('Education_Info3', axis=1, inplace=True)

# 'Education_Info4'
print(train_master['Education_Info4'].value_counts())
# len=6
train_master = train_master.join(pd.get_dummies(train_master.Education_Info4, prefix="Education_Info4"))
train_master.drop('Education_Info4', axis=1, inplace=True)

# 'Education_Info6'
print(train_master['Education_Info6'].value_counts())
# len=6
train_master = train_master.join(pd.get_dummies(train_master.Education_Info6, prefix="Education_Info6"))
train_master.drop('Education_Info6', axis=1, inplace=True)

# 'Education_Info7'
print(train_master['Education_Info7'].value_counts())
temp = train_master['Education_Info7'].copy()
train_master['Education_Info7'] = temp.apply(lambda x: 1 if x == 'E' else 0)

# 'Education_Info8'
print(train_master['Education_Info8'].value_counts())
# len=7
train_master = train_master.join(pd.get_dummies(train_master.Education_Info8, prefix="Education_Info8"))
train_master.drop('Education_Info8', axis=1, inplace=True)

# 'WeblogInfo_19'
print(train_master['WeblogInfo_19'].value_counts())
# len=7
train_master = train_master.join(pd.get_dummies(train_master.WeblogInfo_19, prefix="WeblogInfo_19"))
train_master.drop('WeblogInfo_19', axis=1, inplace=True)

# WeblogInfo_20
# len=20
# modelfit(xgb1, dummies_WeblogInfo_20, y_train)
train_master = train_master.join(pd.get_dummies(train_master.WeblogInfo_20, prefix="WeblogInfo_20"))
train_master.drop('WeblogInfo_20', axis=1, inplace=True)

# WeblogInfo_21
train_master = train_master.join(pd.get_dummies(train_master.WeblogInfo_21, prefix="WeblogInfo_21"))
train_master.drop('WeblogInfo_21', axis=1, inplace=True)
